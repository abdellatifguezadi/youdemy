                ...
                <?php foreach ($courseStudents as $course): ?>
                    <div class="bg-white rounded-lg shadow-md mb-6 overflow-hidden">
                        ...
                        <div class="overflow-x-auto max-h-[400px]">
                            <table class="w-full" style="min-width: auto;">
                                <thead class="bg-gray-50 sticky top-0">
                                    <tr>
                                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider w-[40%] md:w-auto">Student</th>
                                        <th class="hidden md:table-cell px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Email</th>
                                        <th class="hidden md:table-cell px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Enrollment Date</th>
                                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider w-[40%] md:w-auto">Status</th>
                                        <th class="px-6 py-3 text-right text-xs font-medium text-gray-500 uppercase tracking-wider w-[20%] md:w-auto">Actions</th>
                                    </tr>
                                </thead>
